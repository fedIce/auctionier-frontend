    ...
    return (
        <div className='flex space-y-4 flex-col w-full justify-start mt-8 lg:mt-16 mb-4 lg:mb-8 items-start px-2'>
            <div className='flex w-full items-center justify-between'>
                <h4 className='font-bold text-xl text-nowrap'>Section Title</h4>
            ...
            <div id="list_cards_sroll" ref={scrollRef} className="max-w-[100%] flex items-center space-x-2 overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
                {
