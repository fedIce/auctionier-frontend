...
import { ShieldCheckIcon, TruckIcon, ArrowRightIcon, ChevronDownIcon } from "@heroicons/react/24/outline";
            ...
            {!isclosedForBidding &&
                <section className='flex lg:hidden fixed left-0 bottom-0 w-screen items-center justify-start px-2 py-4 bg-background border-t border-third'>
                    ...
                    <div className='flex-1 px-2'>
                        <div className='px-2 py-4 bg-secondary h-full flex justify-center items-center'>
                            <p>Bid</p>
                        </div>
                    </div>
                </section>}
