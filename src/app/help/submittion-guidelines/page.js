        ...
        <div k className='w-full py-4 space-y-8 px-2 lg:px-0 mb-40'>
            <div className='w-full my-4'>
                ...
                <div className='w-full space-y-4'>
                    <div className='w-full text-4xl font-bold uppercase text-center'>Submittion Guidelines</div>
                    <div>{p.introduction}</div>
                </div>
            </div>
            <div className='w-full left-0 flex space-x-4 items-start top-0 '>
                <div className='w-[30%] space-y-8 h-full block border-r border-secondary/10'>
                    {
